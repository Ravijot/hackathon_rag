...
| Component         | Technology Used   | Version    | Notes                                |
|-------------------|-------------------|------------|--------------------------------------|
| Backend           | Python (FastAPI)  | 3.12       | REST API framework                   |
| Frontend          | React.js          | 18.2       | Responsive UI                        |
| Database          | PostgreSQL        | 16         | For structured transaction data      |
| Cache             | Redis             | 7          | Session management & rate limiting   |
| Message Queue     | RabbitMQ          | 3.13       | Async event processing               |
| Containerization  | Docker            | 25.0       | For deployment portability           |
| Orchestration     | Kubernetes        | 1.30       | Cluster management                   |
